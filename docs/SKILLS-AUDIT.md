...
**Уровень 2 — в расширении `pi-app-harness` (R2, работает и в TUI).** ✅ *Первый слайс реализован 2026-07-11 — [harness-extension/](../harness-extension): триггер-матчинг промпта → эфемерный reminder «прочитай SKILL.md скилла X» + todo-first и verify-наджи; см. ROADMAP §6.1-F1.*
