...
**Вывод по thinking (2026-07-11):** для агентных задач у Qwable-v2 стабильнее **minimal/low** — high провоцирует лупы и недоведение (1/3 против 4/4). high оставлять для явных «подумай над архитектурой»-запросов, не как дефолт.
